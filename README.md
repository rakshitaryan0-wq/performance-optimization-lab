...
* `inefficient.js`: The legacy codebase containing the unoptimized algorithmic bottleneck.
* `optimized.js`: The modernized, high-performance refactored solution.
* `REPORT.md`: A detailed analysis of the changes, time complexity reduction, and execution benchmarks

## How to Run
1. Ensure Node.js is installed on your l.ocal machine.
2. Clone this repository and navigate to the project folder.
3. Run the legacy script to observe the baseline execution time: `node inefficient.js`
4. Run the optimized script to observe the performance improvement: `node optimized.js`
